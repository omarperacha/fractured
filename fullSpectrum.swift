...
class fullSpectrum : NSObject{
    ...
    func prepare(){
       ...
       do {file7 = try AKAudioFile(readFileName: options[6])} catch {print("file_7 assertion error")}
        ...
        do {try sampler.loadAudioFiles([file1!, file2!, file3!, file4!, file5!, file6!, file7!, file8!, file9!, file10!, file11!])} catch {print("sampler failed to load files")}
    }
